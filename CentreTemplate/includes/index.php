...
<html lang="en" xml:lang="en"><head>
    ...
    $hours = array(
        ...
        'thu' => array('10:00-23:30'), // Open late
        'fri' => array('10:00-2:00'),
        'sat' => array('10:00-2:00'),
    ...
    if($store_hours->is_open()) {
        echo "<p class='open'>Yes, we're open! Today's hours are " . $store_hours->hours_today() . ".</p>";
    } else {
